.. -*- mode: rst -*-
==========================================
 Keyboards for the Romany language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Romany language. The data and implementations
...
* http://giellatekno.uit.no/romdoc/index.html
* http://divvun.no/doc/tools/docu-rom-manual.html
...
The Romany keyboard sources can be acquired using the `Giella SVN
